...
config.output = 'work_dirs/exp_clip_r50_vs_vit/clip_ratio_20'
...
config.root_pf = '/DATA/ROIs/variants_dataset/ratio_20/train'
config.val_targets = ['/DATA/ROIs/ratio_100/val', '/DATA/ROIs/variants_dataset/ratio_20/val']
config.train_targets = ['/DATA/ROIs/ratio_100/train', '/DATA/ROIs/variants_dataset/ratio_20/train']
config.num_epoch = 20
