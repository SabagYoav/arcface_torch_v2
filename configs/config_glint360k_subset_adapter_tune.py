"""
Docstring for configs.config_glint360k_subset_adapter_tune
...
config.network = "r50"
config.resume = False
config.pretrained_weights = 'work_dirs/glint360k_fullface_augmentations_lr0.001_batch256/checkpoint_gpu_0.pt'
